...
| Positional room-scale | Shared tracking/reconciliation policy | Consumed; current projection/clamp correction host-tested | Headset revalidate wall/tunnel and mixed-motion contacts |
...
| Free-body grab/throw | Shared pose/throw policy | Consumed through BP ownership | Reliable acquisition and stable held placement |
...
| Tracked menu/UI | Shared panel/input policy | Inventory/notebook and native HUD capture mapped | Headset usability/subtitle validation |
...
| Enhanced Visuals | Shared eye-stage calibration | Transferable per-eye stage consumed/host-tested | Headset validation; keep HPL material behavior Overture-owned |
...
- final imported-hand finger/tool validation;
- UI/settings/HUD headset validation;
- HRTF/reverb headset validation and the missing distance/occlusion consumer;
- Enhanced Visuals headset validation and representative chapter progression.
